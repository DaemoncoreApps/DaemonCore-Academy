...
const operatorDockerfile=await readFile(path.join(range,'operator','Dockerfile'),'utf8')
...
assert.match(operatorDockerfile,/libsasl2-modules-gssapi-mit/)
...
assert.match(entrypoint,/samba-tool spn add ldap\/dc01\.daemoncore\.lab 'DC01\$'/)
